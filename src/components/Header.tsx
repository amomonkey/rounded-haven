...
const Header = () => {
  ...
  return (
    <header className="py-4 border-b border-gray-100 bg-white sticky top-0 z-40">
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="md:hidden bg-white absolute top-full left-0 w-full shadow-soft z-40 animate-fade-in">
          <div className="container-custom py-4 flex flex-col">
            <nav className="flex flex-col space-y-4 mb-6">
              <Link 
                to="/product" 
                className="text-gray-600 hover:text-primary-purple transition-colors py-2"
